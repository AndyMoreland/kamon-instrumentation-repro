...
object KamonlagomreproService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The kamon-lagom-repro service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the KamonlagomreproService.
  */
trait KamonlagomreproService extends Service {
  ...
  override final def descriptor = {
    ...
    named("kamon-lagom-repro")
      ...
      .withTopics(
        topic(KamonlagomreproService.TOPIC_NAME, greetingsTopic)
